...
declare function createSelector(node: ParentNode): {
    <Selector extends (string & {}) | keyof HTMLElementTagNameMap>(selector: Selector): Selector extends keyof HTMLElementTagNameMap ? HTMLElementTagNameMap[Selector] : Element;
    <Selector_1 extends (string & {}) | keyof HTMLElementTagNameMap, Validator extends {
        new (): HTMLElement;
