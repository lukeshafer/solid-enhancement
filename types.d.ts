...
export type QueryAllFn = <Q extends keyof HTMLElementTagNameMap, V extends typeof HTMLElement | undefined = undefined>(query: Q, validator?: V) => V extends typeof HTMLElement ? NodeListOf<InstanceType<V>> : NodeListOf<HTMLElementTagNameMap[Q]>;
export {};
